...
void ConVar_Init()
{
	...
	g_cvJockeyMovementVictim = CreateConVar("sm_szf_jockey_movement_victim", "0.15", "Percentage of movement speed applied to victim from jockey grab", _, true, 0.0);
	g_cvJockeyMovementAttacker = CreateConVar("sm_szf_jockey_movement_attacker", "1.05", "Percentage of movement speed applied to jockey during grab", _, true, 0.0);
