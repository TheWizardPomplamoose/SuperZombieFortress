...
void ConVar_Init()
{
	...
	g_cvRatio = CreateConVar("sm_szf_ratio", "0.75", "<0.01-1.00> Percentage of players that start as survivors.", _, true, 0.01, true, 1.0);
	...
	g_cvTankTime = CreateConVar("sm_szf_tank_time", "10", "Adjusts the damage the Tank takes per second. 0 to disable.", _, true, 0.0);
